...
struct ImGuiSettingsHandler
{
    ...
    void*       (*ReadOpenFn)(ImGuiContext* ctx, ImGuiSettingsHandler* handler, const char* name_);              // Read: Called when entering into a new ini entry e.g. "[Window][Name]"
...
public:
    ImGuiWindow(ImGuiContext* context, const char* name_);
    ~ImGuiWindow();
...
namespace ImGui
{
    ...
    IMGUI_API ImGuiWindow*  FindWindowByName(const char* name_);
    ...
    IMGUI_API ImGuiWindowSettings*  CreateNewWindowSettings(const char* name_);
    IMGUI_API ImGuiWindowSettings*  FindWindowSettings(ImGuiID id);
    IMGUI_API ImGuiWindowSettings*  FindOrCreateWindowSettings(const char* name_);
    ...
    IMGUI_API bool          BeginChildEx(const char* name_, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
